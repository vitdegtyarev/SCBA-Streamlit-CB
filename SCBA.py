...
st.write('Degtyarev, V.V., Tsavdaridis, K.D. Buckling and ultimate load prediction models for perforated steel beams using machine learning algorithms. Preprint')
st.write('Link to the site where the preprint is posted')
st.write('Link to ResearchGate')

st.subheader('Source code')
st.markdown('[GitHub](https://github.com/vitdegtyarev/SCBA-Streamlit-CB)', unsafe_allow_html=True)
